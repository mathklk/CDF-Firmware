...
#include <stdint.h>
	...
	#define HAL_MRSUBG_SET_AGC_ENABLED(__ENABLED__)                  MODIFY_REG_FIELD(MR_SUBG_RADIO->AGC0_CTRL, MR_SUBG_RADIO_AGC0_CTRL_AGC_EN, __ENABLED__);
	#define HAL_MRSUBG_SET_AGC_FREEZE_ON_STEADY_ENABLED(__ENABLED__) MODIFY_REG_FIELD(MR_SUBG_RADIO->AGC2_CTRL, MR_SUBG_RADIO_AGC2_CTRL_AGC_FREEZE_ON_STEADY, __ENABLED__);
	#define HAL_MRSUBG_SET_AGC_FREEZE_ON_SYNC_ENABLED(__ENABLED__)   MODIFY_REG_FIELD(MR_SUBG_RADIO->AGC2_CTRL, MR_SUBG_RADIO_AGC2_CTRL_AGC_FREEZE_ON_SYNC, __ENABLED__);
...
static inline uint32_t HAL_GET_UID64_L(void) {
	return *(volatile uint32_t*)(UID64_BASE);
}

static inline uint32_t HAL_GET_UID64_M(void) {
	return *(volatile uint32_t*)(UID64_BASE + 4);
}
